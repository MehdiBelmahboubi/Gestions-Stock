...
public class Fournisseur extends javax.swing.JInternalFrame {
    ...
    public Fournisseur() {
        ...
        try {
            fournisseur_view.populateTable(jTable1);
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if(!e.getValueIsAdjusting()){
                    article_view.SelectRow(jTextField23,jTextField24,jTextField26,jTextField27,jTable1);
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Fournisseur Modifier !!!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField23.getText().equals("")||jTextField24.getText().equals("")||jTextField26.getText().equals("")||jTextField27.getText().equals(""))
        {
            jLabel9.setText("Veuiller remplir Tous les Champs !!!");
            jLabel9.setVisible(true);
        }else {
            try {
                fournisseur_view.addfournisseur(jTextField23, jTextField24, jTextField26, jTextField27, jTable1);
                jLabel10.setText("Fournisseur Ajouter !!!");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jTextField23.getText().equals("")||jTextField24.getText().equals("")||jTextField26.getText().equals("")||jTextField27.getText().equals(""))
        {
            ...
            fournisseur_view.Updatefournisseur(jTextField23, jTextField24, jTextField26, jTextField27, jTable1);
            jLabel10.setText("Fournisseur Modifier !!!");
            jLabel10.setVisible(true);
            jLabel9.setVisible(false);
            fournisseur_view.clear(jTextField23, jTextField24, jTextField26, jTextField27, jTable1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTextField23.getText().equals(""))
        {
            ...
            try {
                fournisseur_view.Searchfournisseur(jTextField23,jTable1);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        String titre = "Liste des Fournisseurs";
