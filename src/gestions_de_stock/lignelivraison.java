...
import Table_data.lignelivraison_view;
 ...
 * @author macair
 */
public class lignelivraison extends javax.swing.JInternalFrame {

    /**
     * Creates new form lignelivraison
     */
    Color defaultcolor = new Color(173,203,227);
    public lignelivraison() {
        initComponents();
        try {
            lignelivraison_view.populateTable(jTable1);
            lignelivraison_view.populateCombo2(jComboBox2);
            lignelivraison_view.populateCombo1(jComboBox1);
            lignelivraison_view.clear(jTextField23,jTextField26,jComboBox1,jComboBox2,jTable1);
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if(!e.getValueIsAdjusting()){
                    lignelivraison_view.SelectRow(jTextField23,jTextField26,jComboBox1,jComboBox2,jTable1);
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestions Lignes livraison");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField23.getText().equals("")||jTextField26.getText().equals("")||jComboBox1.toString().equals("")||jComboBox2.toString().equals(""))
        {
            ...
            try {
                lignelivraison_view.addLigneliv(jTextField23,jTextField26, jComboBox1, jComboBox2, jTable1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(jTextField23.getText().equals("")||jTextField26.getText().equals("")||jComboBox1.toString().equals("")||jComboBox2.toString().equals(""))
        {
            ...
            int option = JOptionPane.showConfirmDialog(null, "Êtes-vous sûr de vouloir supprimer cette ligne de livraison?", "Confirmation", JOptionPane.YES_NO_OPTION);

            if (option == JOptionPane.YES_OPTION) {
                lignelivraison_view.DeleteLigneliv(jTextField23, jTable1);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jTextField23.getText().equals("")||jTextField26.getText().equals("")||jComboBox1.toString().equals("")||jComboBox2.toString().equals(""))
        {
            ...
            lignelivraison_view.UpdateLigneliv(jTextField23,jTextField26, jComboBox1,jComboBox2 , jTable1);
            jLabel10.setText("Ligne Modifier !!!");
            jLabel10.setVisible(true);
            jLabel9.setVisible(false);
            lignelivraison_view.clear(jTextField23,jTextField26, jComboBox1,jComboBox2 , jTable1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTextField23.getText().equals(""))
        {
            ...
            try {
                lignelivraison_view.SearchLigneliv(jTextField23,jTable1);
