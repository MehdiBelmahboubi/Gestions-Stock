...
public class Commande extends javax.swing.JInternalFrame {
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if(!e.getValueIsAdjusting()){
                    Commande_views.SelectRow(jTextField23,jComboBox1,jTextField1,jTable1);
                }
            }
        });
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField23.getText().equals("")||jComboBox1.toString().equals("")||jTextField1.getText().equals(""))
        {
            jLabel9.setText("Veuiller remplir Tous les Champs !!!");
            jLabel9.setVisible(true);
        }else {
            try {
                Commande_views.addCommande(jTextField23, jComboBox1, jTextField1, jTable1);
                jLabel10.setText("Commande Ajouter !!!");
                jLabel10.setVisible(true);
                jLabel9.setVisible(false);
                Commande_views.clear(jTextField23, jComboBox1, jTextField1, jTable1);
            } catch (SQLException e) {
